...
class EngineType(Enum):
    ...
    RVC = ("RVC", False, False, ["1", "2", "v1"], "2", 15, 3, False, True)
    ...
    QWEN3_TTS = ("Qwen3TTS", True, True, ["1.7B-Base", "0.6B-Base"], "1.7B-Base", 15, 3, True, True)
    OMNIVOICE = ("OmniVoice", True, True, ["1"], "1", 10, 3, True, True)
    MOSS_TTS = ("MOSS-TTS", True, True, ["1"], "1", 10, 3, True, True)
