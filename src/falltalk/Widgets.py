...
from src.falltalk.audio_player import StandardAudioPlayerBar
from src.falltalk.audio_recorder import StandardAudioRecorderBar
from src.falltalk import falltalkutils
from src.falltalk.config import RangeSettingCardScaled, cfg, TextSettingCard, RadioSettingCard, ComboBoxSettingsCard, RvcComboBoxSettingsCard, FileValidator, CUSTOM_DISCLAIMER, CustomFolderValidator, SpinSettingCard, ComboBoxWordsCard
from src.falltalk.main_settings import FallTalkSettings
from src.falltalk.rvc_settings import RVCSettings
from src.falltalk.xtts_settings import XTTSSettings
from src.falltalk.faq import FAQPage
from src.falltalk.gpt_sovits_settings import GPTSoVITSSettings
from src.falltalk.icons import FallTalkIcons, FallTalkStrokeIcons
from src.falltalk.styletts2_settings import StyleTTS2Settings
...
class LlasaWidget(GenerationWidget):
    ...
    def __init__(self, parent=None):
        super().__init__(parent=parent, text="Llasa")
        self.text_input.setPlaceholderText("Please Select the 'Transcribe Reference Audio' button below")
        self.transcribe_state = None
        self.words_data = None
...
class BulkGenerationWidget(FallTalkWidget):
    ...
    def __onShowGettingStarted(self):
        ...
        content = """
        The bulk file generation will use the currently loaded TTS engine. 
        
        Recommendations are F5 or GPT_SoVITS. RVC will run with each engine as needed, you do not need to set the engine to RVC. 
