...
class OrpheusWidget(GenerationWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.temperature_orpheus_card = RangeSettingCardScaled(
            cfg.temperature_orpheus,
            FIF.FRIGID,
            self.tr('Temperature'),
        ...
        self.temp_and_speed_layout.addWidget(self.temperature_orpheus_card, 3)
        ...
        # Insert Orpheus specific settings before the RVC settings
        ...
        self.setVisible(cfg.engine.value == "Orpheus")
        self.media_player.setVisible(cfg.engine.value == "Orpheus")
