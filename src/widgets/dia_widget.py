...
class DIAWidget(GenerationWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.temperature_dia_card = RangeSettingCardScaled(
            cfg.temperature_dia,
            FIF.FRIGID,
            self.tr('Temperature'),
        ...
        self.temp_and_speed_layout.addWidget(self.temperature_dia_card, 3)
        ...
        # Insert DIA specific settings before the RVC settings
