...
class HiggsHelp(ScrollArea):
    ...
    def __init__(self, parent: GenerationWidget):
        ...
        self.info = TextCard(
            ...
            """
            <ul>
            <li>Higgs Audio is a high-quality text-to-speech model that can generate natural-sounding speech.</li>
            <li>It uses reference audio to match the voice characteristics and speaking style.</li>
            </ul> 
            """,
            height=80
        )
        ...
        self.text = TextCard(
            ...
            <li>The RAS (Repetition Avoidance Sampling) parameters help prevent repetitive patterns in the generated audio.</li>
            </ul>
            """,
            height=200
        )
