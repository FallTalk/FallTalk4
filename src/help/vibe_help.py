...
class VibeHelp(ScrollArea):
    ...
    def __init__(self, parent: GenerationWidget):
        ...
        self.info = TextCard(
            ...
            """
            <ul>
            <li>Vibe Audio is a high-quality text-to-speech model that can generate natural-sounding speech by Microsoft</li>
        ...
        self.text = TextCard(
            ...
            <li>For better cloning, provide at least 30 seconds of reference audio.</li>
